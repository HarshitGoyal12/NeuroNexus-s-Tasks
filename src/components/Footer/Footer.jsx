  ...
  return (
    ...
    >
      <StackColumn>
        ...
        <FooterLink 
        text={'10th kameti, Bangalore 92382, eng'} 
        />
        <FooterLink 
     ...
     <StackColumn>
        <FooterTitle text={'Our Offerings'} />
        <FooterLink text={'Purchase Property'} />
        <FooterLink text={'Sell Property'}/> 
        <FooterLink text={'Rent Property'} />
        <FooterLink text={'Construct Property'} />
      </StackColumn>
      <StackColumn>
